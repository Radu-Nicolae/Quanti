...
class EnergyMonitor:
    def __init__(self, interval_ms=100, run_name=now_tag()):
    ...
    def stop(self, meta=None):
        ...
        with self._lock:
            ...
            energy_wh = (self.avg_power * duration_s) / 3600.0
            ...
            summary = {
                ...
                "avg_util_pct": round(self.avg_util, 2),
                "avg_mem_MiB": round(self.avg_mem, 2),
            ...
            print(f"✅ Energy monitoring complete:")
            print(f"   Duration: {duration_s:.2f}s")
            print(f"   Samples: {self.samples}")
            print(f"   Avg Power: {self.avg_power:.2f}W")
